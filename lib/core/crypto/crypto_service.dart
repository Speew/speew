...
class CryptoService {
  ...
  /// Gera Prova de Trabalho (Hashcash)
  Future<String> generatePoW(String data, int difficulty) async {
    // Simulação: Retorna um nonce simples
    return 'PoW_Nonce_${DateTime.now().millisecondsSinceEpoch}';
  }

  /// Verifica Prova de Trabalho (Hashcash)
  Future<bool> verifyPoW(String data, String nonce, int difficulty) async {
